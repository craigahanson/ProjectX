...
function privateApplyMigrations {
    ...
    if($Configuration -eq "Development"){
        ...
        dotnet ef database update --project src/ProjectX.Data.EntityFrameworkCore --startup-project src/ProjectX.Data.EntityFrameworkCore -- "Server=$ServerInstance;Initial Catalog=$DatabaseName;User ID=$ServerUsername;Password=$ServerPassword;Encrypt=True", 30
    }
}
