...
function privateApplyMigrations {
    ...
    if($Configuration -eq "Development"){
        ...
        dotnet ef database update --project src/ProjectX.Data.EntityFrameworkCore --startup-project src/ProjectX.Data.EntityFrameworkCore -- "Server=$ServerInstance;Database=$DatabaseName;User ID=$ServerUsername;Password=$ServerPassword;Trusted_Connection=False;Encrypt=True;TrustServerCertificate=true", 5
    }
}
